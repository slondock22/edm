...
<div class="page-wrapper">
    ...
    <!-- Bnner Section -->
    <section class="banner-section-three" style="background-image:url(http://www.trade2gov.com/coffee-morning/assets/landing/images/main-slider/1.jpg);">
        <div class="auto-container clearfix">
            <div class="content-box" style="width:100%; max-width:100% !important; text-align:center;">
                <div class="text" style="margin-bottom:63px; margin-top:-150px; font-size:4em">Doorprize </div>
...
<script>
        $(document).ready(function () {
            ...
            $('#wheels').load(function() { 
                // $('#wheels').contents().find('.navbar').hide();
            }).attr('src','http://www.trade2gov.com/coffee-morning/doorprize/index.php');
        });
