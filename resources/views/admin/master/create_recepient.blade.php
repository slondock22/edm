...
<div class="page-inner">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form name="formCreateRecepient" id="formCreateRecepient" method="POST" enctype="multipart/form-data" action="{{route('admin.master.recepient_store')}}">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                    <div class="card-title">Add Recepient New</div>
