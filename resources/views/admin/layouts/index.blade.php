...
<head>
	...
	<title>PT.EDI INDONESIA | EVENT ORGANIZER MANAGER</title>
	...
	<script>
		WebFont.load({
			...
			urls: [APP_URL+'/assets/admin/css/fonts.min.css']},
			active: function() {
	...
	<link rel="stylesheet" href="{{asset('/assets/admin/css/plugin/datetimepicker/bootstrap-datetimepicker.min.css')}}">
...
<body>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.html" class="logo">
					<img src="{{asset('/assets/admin/img/eomanager.png')}}" width="150px" alt="navbar brand" class="navbar-brand">
				</a>
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="{{asset('/assets/admin/img/girl.png')}}" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="{{asset('/assets/admin/img/girl.png')}}" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Hizrian</h4>
					...
					<div class="user">
						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									{{Auth::user()->name}}
									<span class="user-level">{{Str::title(Auth::user()->role)}}</span>
	...
	<script src="{{asset('/assets/admin/js/plugin/datetimepicker/bootstrap-datetimepicker.min.js')}}"></script>
